...
<html>
	...
	<body id="duas-colunas" class="brasil">
		...
		<div id="container">
			...
			<img class="imagem-principal" src="../imagens/departamento.jpg" width="100%" alt="imagem caneta escrevendo no caderno">
														
			</div>

			<div class="caixa-conteudo">

							<iframe width="90%" height="315" src="https://www.youtube.com/embed/MMc7uQIV4eE" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
